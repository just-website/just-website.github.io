...
const toggleHideAnimation = (triggerName) => {
...
const toggleHideTrAnimation = (triggerName) => {
    return Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["trigger"])(triggerName, [
        Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["state"])(':enter', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["style"])({
            opacity: '1',
            margin: '*'
...
const modalShowAnimation = (triggerName) => {
    return Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["trigger"])(triggerName, [
        Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["state"])(':leave', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["style"])({
            opacity: '1',
            height: '*'
...
let AppComponent = class AppComponent {
    ...
    ngOnInit() {
        this.data.getData().subscribe((goods) => {
    ...
    parseGoods(categoryGroupGoods) {
        return categoryGroupGoods.skus.map(goods => {
            return Object.assign({}, goods, { groupName: categoryGroupGoods.group.name, groupId: categoryGroupGoods.group.id });
        });
    }
    addGoods(event) {
...
module.exports = ".table {\n  width: calc(100% - 40px);\n  min-width: 640px;\n  margin: 20px auto;\n  padding: 20px;\n  border-collapse: collapse;\n  position: relative;\n  max-width: 1280px;\n}\n.table td, .table th {\n  padding: 20px 10px;\n  -moz-text-align-last: left;\n       text-align-last: left;\n}\n.table td p, .table th p {\n  padding: 0;\n  margin: 0;\n}\n.table th {\n  border-bottom: 1px solid #212121;\n}\n.table th:nth-child(1) {\n  width: 100px;\n}\n.table th:nth-child(2) {\n  width: 150px;\n}\n.table th:nth-child(3), .table th:nth-child(4) {\n  cursor: pointer;\n  min-width: 70px;\n}\n.table .table__checkbox {\n  text-align: center;\n}\n.table .table__checkbox label {\n  height: 22px;\n  display: flex;\n  justify-content: center;\n  width: 100%;\n  text-align: center;\n  cursor: pointer;\n}\n.table .table__checkbox input[type=checkbox] {\n  display: none;\n}\n.table .table__checkbox input[type=checkbox]:checked + .table__checkbox-item {\n  position: relative;\n}\n.table .table__checkbox input[type=checkbox]:checked + .table__checkbox-item::before {\n  position: absolute;\n  display: block;\n  content: \"\";\n  width: 10px;\n  height: 10px;\n  top: 4px;\n  left: 4px;\n  background-color: #212121;\n  border-radius: 2px;\n}\n.table .table__checkbox-item {\n  display: inline-block;\n  width: 18px;\n  height: 18px;\n  border: 2px solid #212121;\n  border-radius: 2px;\n  box-shadow: 0 10px 20px rgba(0, 0, 0, 0.2), 0 7px 10px rgba(0, 0, 0, 0.2);\n}\n.table__arrow-icons {\n  margin: 0;\n  padding: 0;\n  position: relative;\n  display: inline-block;\n  cursor: pointer;\n}\n.table__arrow-icons::before, .table__arrow-icons::after {\n  content: \"\";\n  cursor: pointer;\n  position: absolute;\n  top: 6px;\n  right: -20px;\n  width: 3px;\n  height: 10px;\n  background-color: #212121;\n  pointer-events: none;\n  -webkit-transform: rotate(45deg);\n          transform: rotate(45deg);\n  transition: 0.25s;\n}\n.up .table__arrow-icons::before, .up .table__arrow-icons::after {\n  -webkit-transform: rotate(-45deg);\n          transform: rotate(-45deg);\n}\n.table__arrow-icons:after {\n  -webkit-transform: rotate(-45deg);\n          transform: rotate(-45deg);\n  right: -14px;\n}\n.up .table__arrow-icons:after {\n  -webkit-transform: rotate(45deg);\n          transform: rotate(45deg);\n}\n/*# sourceMappingURL=data:application/json;base64, */"
